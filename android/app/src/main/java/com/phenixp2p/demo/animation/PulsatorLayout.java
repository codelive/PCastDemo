...
package com.phenixp2p.demo.animation;
...
public class PulsatorLayout extends RelativeLayout {
  ...
  public PulsatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    // get attributes
    TypedArray attr = context.getTheme().obtainStyledAttributes(attrs, R.styleable.Pulse, 0, 0);
    ...
    try {
      mCount = attr.getInteger(R.styleable.Pulse_pulse_count, DEFAULT_COUNT);
      mDuration = attr.getInteger(R.styleable.Pulse_pulse_duration, DEFAULT_DURATION);
      mRepeat = attr.getInteger(R.styleable.Pulse_pulse_repeat, DEFAULT_REPEAT);
      mStartFromScratch = attr.getBoolean(R.styleable.Pulse_pulse_startFromScratch, DEFAULT_START_FROM_SCRATCH);
      mColor = attr.getColor(R.styleable.Pulse_pulse_color, DEFAULT_COLOR);
      mInterpolator = attr.getInteger(R.styleable.Pulse_pulse_interpolator, DEFAULT_INTERPOLATOR);
    } finally {
      attr.recycle();
    }
